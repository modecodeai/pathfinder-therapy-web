...
.pfHeroConversion { margin-top: 24px; display: grid; gap: 16px; max-width: 36rem; }
.pfHeroValue { margin: 0; font-size: clamp(1rem, 2vw, 1.15rem); line-height: 1.65; color: rgba(246,242,234,.88); }
...
@media (max-width: 900px) { .pfStickyBook { display: block; } body { padding-bottom: 84px; } }
@media (min-width: 901px) { .pfStickyBook { display: none !important; } }
</style>`;
...
const HOMEPAGE_HERO_INJECTION = `<div class="pfHeroConversion">
  <p class="pfHeroValue"><strong>Brent Kelly</strong> — registered psychotherapist offering trauma-informed therapy in <strong>Lisbon</strong> and <strong>online across Portugal</strong>.</p>
...
function applyHomepageUx(html) {
  ...
  if (!next.includes("pfHeroConversion")) {
    next = next.replace(
